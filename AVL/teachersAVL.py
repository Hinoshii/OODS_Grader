...
avl1 = AVLTree()
avl1.add(nameValue("Arisu"))
avl1.add(nameValue("Neru"))
avl1.add(nameValue("Toki"))
avl1.add(nameValue("Momoi"))
avl1.add(nameValue("Midori"))
avl1.add(nameValue("Noa"))
avl1.add(nameValue("Hatsumi"))
avl1.add(nameValue("Mika"))
avl1.add(nameValue("Skul1CrowN"))
avl1.add(nameValue("Yuzu"))
print(avl1)

avl1.delete(nameValue("Arisu"))
print(avl1)
avl1.delete(nameValue("Noa"))
print(avl1)
avl1.delete(nameValue("Toki"))
print(avl1)
avl1.delete(nameValue("Yuzu"))
print(avl1)