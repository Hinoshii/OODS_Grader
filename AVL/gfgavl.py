...
myTree = AVL_Tree()
root = None
nums = [516,410,407,513,612,286,731,386,953,445]
...
# Delete
root = myTree.delete(root, 516)
root = myTree.delete(root, 286)
root = myTree.delete(root, 407)
root = myTree.delete(root, 445)
